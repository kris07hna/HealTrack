...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 relative overflow-hidden">
      ...
      {/* Desktop Layout Container - Flex Layout */}
      <div className="flex h-screen">
        {/* Sidebar - Fixed width, responsive */}
        <div className={`
          fixed inset-y-0 left-0 z-50 w-80 transform transition-transform duration-300 ease-in-out
          lg:relative lg:translate-x-0 lg:flex lg:flex-col lg:w-80
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <motion.div 
            initial={{ y: -20, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            className="glass-navbar border-b border-white/20 sticky top-0 z-30 backdrop-blur-xl bg-white/60 shadow-xl"
          >
              ...
              <div className="flex justify-between items-center h-20">
                <div className="flex items-center">
                  ...
                  <div className="ml-4 lg:ml-0">
                    ...
                    <p className="text-gray-600 text-sm mt-1 hidden sm:block">Track your wellness journey with precision</p>
                  </div>
                </div>
                <div className="flex items-center space-x-2 sm:space-x-4">
                  ...
                  <motion.div 
                    ...
                    animate={{ opacity: 1 }}
                    transition={{ delay: 0.2 }}
                    className="hidden sm:block glass-card bg-white/40 border border-white/30 px-4 sm:px-6 py-3 rounded-2xl shadow-sm"
                  >
                ...
                {dashboardData && (
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      animate={{ opacity: 1, scale: 1 }}
                      transition={{ delay: 0.1 }}
                      className="glass-card bg-gradient-to-r from-white/60 to-white/40 border border-white/30 p-6 sm:p-8 rounded-3xl shadow-xl relative overflow-hidden"
                    >
                    ...
                    >
                      <div className="glass-card bg-gradient-to-br from-white/60 to-white/40 border border-white/30 p-6 sm:p-8 rounded-3xl shadow-xl relative overflow-hidden card-3d">
                        ...
                        <div className="relative z-10">
                          <div className="flex items-center justify-between mb-6">
                            <h3 className="text-lg sm:text-xl font-bold text-gray-800">Weekly Progress</h3>
                            <motion.div 
                      ...
                      <div className="glass-card bg-gradient-to-br from-white/60 to-white/40 border border-white/30 p-6 sm:p-8 rounded-3xl shadow-xl card-3d">
                        <div className="flex items-center justify-between mb-6">
                          <h3 className="text-lg sm:text-xl font-bold text-gray-800">Health Score</h3>
                          <motion.div 
                            whileHover={{ scale: 1.2, rotate: 360 }}
                        ...
                        <div className="text-center">
                          ...
                          <div className="text-base sm:text-lg text-gray-600 font-medium">Out of 10</div>
                      ...
                      <div className="glass-card bg-gradient-to-br from-white/60 to-white/40 border border-white/30 p-6 sm:p-8 rounded-3xl shadow-xl card-3d md:col-span-2 xl:col-span-1">
                        <div className="flex items-center justify-between mb-6">
